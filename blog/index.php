...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  ...
  <div class="div">
    ...
    <div style="text-align: center;width: 62rem;margin:auto;justify-content: center;">
      <h1 style="text-align: center;">Welcome to Our Blog</h1>
      <h3>Don’t focus on having a great blog. Focus on producing a blog that’s great for your readers.” – <span style="font-weight: 700;">Brian Clark</span></h3>
    </div>
